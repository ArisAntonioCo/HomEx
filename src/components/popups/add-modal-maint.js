...
import { addMaintenanceExpense } from "../../Redux/maintSlice";
import "./add-modal-maint.css";
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const resultAction = await dispatch(
        addMaintenanceExpense({ ...formData, datePaid: isoDatePaid })
      );
  
      // Check if adding the expense was successful
      if (addMaintenanceExpense.fulfilled.match(resultAction)) {
        const successMessage = "Maintenance expense added successfully!";
