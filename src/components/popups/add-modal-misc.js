  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const resultAction = await dispatch(
        addMiscellaneousExpense({ ...formData, datePaid: isoDatePaid })
      );
  
      // Check if adding the expense was successful
      if (addMiscellaneousExpense.fulfilled.match(resultAction)) {
        const successMessage = "Miscellaneous expense added successfully!";
